...
class CertificateParameters(BaseModel):
    DocumentNumber: str = Field(..., description='Document Number', examples=['123113'])
...
class KecerCertificatePostRequest(BaseModel):
...
class KecerCertificatePostResponse(BaseModel):
...
class KecerCertificatePostResponse1(BaseModel):
...
class KecerCertificatePostResponse2(BaseModel):
...
class KecerCertificatePostResponse3(BaseModel):
...
class KecerCertificatePostResponse4(BaseModel):
...
class KecerCertificatePostResponse5(BaseModel):
...
class KecerCertificatePostResponse6(BaseModel):
...
class CertificateParameters1(BaseModel):
    DocumentNumber: str = Field(
        ..., description='DocumentNumber', examples=['12345678']
    )


class TapcnCertificatePostRequest(BaseModel):
...
class TapcnCertificatePostResponse(BaseModel):
...
class TapcnCertificatePostResponse1(BaseModel):
...
class TapcnCertificatePostResponse2(BaseModel):
...
class TapcnCertificatePostResponse3(BaseModel):
...
class TapcnCertificatePostResponse4(BaseModel):
...
class TapcnCertificatePostResponse5(BaseModel):
...
class TapcnCertificatePostResponse6(BaseModel):
...
class CertificateParameters2(BaseModel):
    DocumentNumber: str = Field(
        ..., description='Document Number', examples=['SRP-JN-1-2015-16-NT']
    )


class TdlcsCertificatePostRequest(BaseModel):
...
class TdlcsCertificatePostResponse(BaseModel):
...
class TdlcsCertificatePostResponse1(BaseModel):
...
class TdlcsCertificatePostResponse2(BaseModel):
...
class TdlcsCertificatePostResponse3(BaseModel):
...
class TdlcsCertificatePostResponse4(BaseModel):
...
class TdlcsCertificatePostResponse5(BaseModel):
...
class TdlcsCertificatePostResponse6(BaseModel):
...
class UgdcnCertificatePostRequest(BaseModel):
...
class UgdcnCertificatePostResponse(BaseModel):
...
class UgdcnCertificatePostResponse1(BaseModel):
...
class UgdcnCertificatePostResponse2(BaseModel):
...
class UgdcnCertificatePostResponse3(BaseModel):
...
class UgdcnCertificatePostResponse4(BaseModel):
...
class UgdcnCertificatePostResponse5(BaseModel):
...
class UgdcnCertificatePostResponse6(BaseModel):
